...
| 2026-08-24 | macOS arm64 | 3.9.6 | Pass | 501 Host tests through checkpoint 028: versioned external physical-layout evidence, exact provider/operation/QuantSpec/catalog/profile/environment/kernel/artifact/ABI/suite/result closure, evidence-only non-logical authority selection and run-time KV rebinding; synthetic evidence only, default evidence empty, no NPU package/runtime/operator used |
| 2026-08-24 | macOS arm64 | 3.9.6 | Pass | 509 Host tests through checkpoint 029: bounded strict JSON package evidence manifest, safe scoped result locators, exact payload set/size/SHA-256 verification, verified immutable bundle bootstrap and package/adapter/version/catalog drift gates; synthetic bytes only, no filesystem/package import/NPU operator used |
| 2026-08-24 | macOS arm64 | 3.9.6 | Pass | 527 Host tests through checkpoint 030: independent `flashinfer_npu.jit` spec/registry/environment/cache-decision package, Attention static variant and exact selected-plan/receipt binding, dynamic-length recipe reuse, quantization cache identity and isolated import gate; no compiler, loader, external package, NPU runtime or operator used |
| 2026-08-24 | macOS arm64 | 3.9.6 | Pass | 539 Host tests through checkpoint 031: wrapper-owned JIT cache-hit resolution before callable import, JIT binding in active-plan/runtime identity, atomic failed/successful replan, run-time drift gate and concurrent registry/cache publication; synthetic cache/fake executors only, no compiler, loader, external package, NPU runtime or operator used |
| 2026-08-24 | macOS arm64 | 3.9.6 | Pass | 550 Host tests through checkpoint 032: injected JIT artifact byte reader, exact size/SHA-256 verification receipt, pre-import corruption gate, artifact identity in active-plan publication, failed-replan atomicity and run-time drift detection; synthetic in-memory bytes only, no filesystem reader, compiler, loader, external package, NPU runtime or operator used |
...
| 2026-08-24 | Ubuntu 24.04 x86_64 | 3.10.8 | Pass | Checkpoint 028 isolated wheel, matching SHA-256 inputs and 8/8 versioned physical-layout evidence, exact authority success, missing/duplicate/drift fail-closed and provider-free public signature tests; forbidden module set empty, no torch_npu/flash_attn import or Attention callable execution |
| 2026-08-24 | Ubuntu 24.04 x86_64 | 3.10.8 | Pass | Checkpoint 029 isolated wheel, matching SHA-256 inputs and 8/8 bounded manifest JSON, safe locator, result payload set/size/digest, verified bundle/runtime identity and public-surface isolation tests; forbidden module set empty, no provider package import or Attention callable execution |
| 2026-08-24 | Ubuntu 24.04 x86_64 | 3.12.3 | Pass | Checkpoint 030 isolated wheel (`940d336c0ce35d0bf1090e18fb6ff94a28ef5018b0f003a03bed044ed32ad7de`), 18/18 JIT package/spec/registry/environment/cache-policy and selected Attention plan binding tests; forbidden import set empty, no compiler, loader, provider package, NPU runtime or operator execution |
| 2026-08-24 | Ubuntu 24.04 x86_64 | 3.12.3 | Pass | Checkpoint 031 isolated wheel (`d2c7df155a5ef31a3b3b8503bd769fe7d6ca60d9579f36986ea876b3a56209f6`), 12/12 wrapper-owned JIT resolution, active-plan identity, pre-import cache gate, atomic replan, run-time drift and concurrent publication tests; no compiler, loader, real provider import, NPU runtime or operator execution |
| 2026-08-24 | Ubuntu 24.04 x86_64 | 3.12.3 | Pass | Checkpoint 032 isolated wheel (`27cacc7b39ba1b4980f1b4558b0498eac6020143816f0c4b4819f61624e4194c`), 11/11 injected artifact bytes, exact size/SHA-256 receipt, pre-import corruption rejection, atomic replan and run-time binding drift tests; synthetic in-memory bytes only, no filesystem reader, compiler, loader, real provider import, NPU runtime or operator execution |
